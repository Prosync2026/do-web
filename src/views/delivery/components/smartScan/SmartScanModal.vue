...
<template>
    <Dialog v-model:visible="visible" modal :closable="!isScanning" :style="{ width: '860px', maxWidth: '95vw' }" :pt="{ content: { class: 'p-0' } }" @hide="onClose">
        <template #header>
        ...
        <!-- ─── STEP: RESULT ───────────────────────────────────────────── -->
        <div v-else-if="phase === 'result'" class="p-5">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-5">
                ...
                <div class="flex flex-col gap-1 sm:col-span-3">
                    ...
                    <InputText v-model="ocrResult.supplierName" size="small" placeholder="Supplier name" class="w-full sm:w-1/2" />
                </div>
            </div>
