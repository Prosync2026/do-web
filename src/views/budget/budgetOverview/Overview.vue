    ...
    <!-- <div class="grid grid-cols-12 gap-4 mt-6 items-stretch">
        ...
        <div class="col-span-12 lg:col-span-6 flex flex-col">
            <div class="glossy-card mb-0 p-4 rounded-lg border border-gray-300 relative flex-1 flex flex-col items-center">
                <span class="self-start font-bold text-black-500 mb-10"> <PhMapPin :size="18"  style="margin-right: 5px" /> Budget by Location </span>
        ...
        <div class="col-span-12 lg:col-span-6 flex flex-col">
            <div class="glossy-card mb-0 p-4 rounded-lg border border-gray-300 relative flex-1 flex flex-col">
                <div class="w-full flex items-center justify-between mb-4">
                    <div>
                        <span class="font-bold text-black-500 block"> <PhEject :size="18" class="mr-1"  /> {{ breadcrumbTitle }} </span>
                    ...
                    <Button v-if="level > 0" label="Back" class="p-button-sm" @click="goBack">
                        <template #icon><PhArrowLeft class="mr-2" /></template>
                    </Button>
                </div>
