...
<template>
    <Dialog v-model:visible="localVisible" header="Edit Budget Item" modal closable :style="{ width: '700px' }"
        @hide="close">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <InputText
                    :value="`RM ${computedAmount.toLocaleString('en-MY', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`"
                    class="w-full bg-gray-50 text-gray-500" readonly />
            </div>
