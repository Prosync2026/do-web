...
<template>
    <Teleport to="body">
        <ProModal v-model="localVisible" title="Add Single Budget Item" size="lg" @update:modelValue="!$event && close()">
            ...
            <template #footer>
                <div class="flex justify-end gap-2">
                    <ProButton variant="secondary" @click="close">Cancel</ProButton>
                    <ProButton variant="primary" @click="submit">Add Item</ProButton>
                </div>
            </template>
        </ProModal>
    </Teleport>
