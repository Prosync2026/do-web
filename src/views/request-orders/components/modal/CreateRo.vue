...
<template>
    <ProModal :modelValue="localVisible" @update:modelValue="(val: boolean) => { localVisible = val; $emit('update:visible', val); }" title="Add Bulk Items from Budget" size="full" class="create-ro-modal">
